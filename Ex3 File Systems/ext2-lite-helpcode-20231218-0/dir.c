...
Eend:
	if (!quiet) {
		p = (ext2_dirent *)(kaddr + offs);
		ext2_error(sb, __func__, "entry in directory #%lu spans the page boundary offset=%lu, inode=%lu",
...
ext2_dirent *ext2_dotdot(struct inode *dir, struct page **p)
{
...
/* Releases the page */
void ext2_set_link(struct inode *dir, ext2_dirent *de,
 ...
 */
int ext2_delete_entry(ext2_dirent *dir, struct page *page)
{
